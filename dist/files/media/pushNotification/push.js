	...
	window.lpgPush = {
		...
		init: function() {
			...
			if (!isInstalling && regId && Notification.permission !== 'granted') {
				lpgPush.ajax('https://lpgenerator.ru:8443/mailer/web-push/unsubscribe/', JSON.stringify({reg_id: regId}), function() {
		...
		subscribe: function() {
			...
			reg.pushManager
				...
				.then(function (pushSubscription) {
					...
					ep.match(/(.*)\/([^\/]+)/);
					var regId = RegExp.$2;
					lpgPush.ajax('https://lpgenerator.ru:8443/mailer/web-push/subscribe/', data, function() {
